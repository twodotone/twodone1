...
def run_value_backtest(year, weeks, value_threshold, recent_games_window, recent_form_weight):
    ...
    for week in weeks:
        ...
        for game in week_schedule.itertuples():
            ...
            home_field_advantage = HFA_DATA.get(home_team, 1.5)
            model_home_spread = generate_stable_matchup_line(home_stats_w, away_stats_w, home_field_advantage=home_field_advantage)
